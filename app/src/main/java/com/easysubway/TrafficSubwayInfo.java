...
public class TrafficSubwayInfo extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //subway_inf = findViewById(R.id.subway_inf);

      /*  Bundle extra=getIntent().getExtras();
        if(extra.getBoolean("is_theme_white")==false)
        {
            setContentView(R.layout.traffic_subway_info_black);
        }
        else
        {
            setContentView(R.layout.traffic_subway_info);
        }*/
        ...
        else
        {
            ...
            this.setContentView(R.layout.traffic_subway_info_black);
        }
